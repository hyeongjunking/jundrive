...
<tr><th>성명</th>
	<td><input class='w-px120' type='text' value='${vo.last_name }' name='last_name'>
		<input class='w-px120' type='text' value='${vo.first_name }' name='first_name'>
	</td>
</tr>
<tr><th>부서</th>
	<td>
	<select name='department_id' class='w-px220'>
...
<tr><th>업무</th>
	<td>
		<select name='job_id' class='w-px220'>
